...
var work = {
    jobs: [{
            ...
            date: 'February 2001 - February 2012',
    ...
    display: function() {
        for (var i = 0; i < work.jobs.length; i++) {
            ...
            $('#workExperience').append(HTMLworkStart)
                .append(HTMLworkEmployer.replace("%data%", work.jobs[i].employer))
                .append(HTMLworkTitle.replace("%data%", work.jobs[i].title))
                .append(HTMLworkDates.replace("%data%", work.jobs[i].date))
...
var projects = {
    projects: [{
        ...
        description: 'Took a design mockup as a PDF-file  and I replicated that design in HTML and CSS. Plus it is responsive website that displays images, descriptions and links to each of the portfolio projects I would complete throughout the course of the Front-End Web Developer Nanodegree.',
    ...
    display: function() {
        for (var i = 0; i < projects.projects.length; i++) {
            ...
            $('#projects').append(HTMLprojectStart)
                .append(HTMLprojectTitle.replace("%data%", projects.projects[i].title))
    ...
    display: function() {
        for (var i = 0; i < education.schools.length; i++) {
            ...
            $('#education').append(HTMLschoolStart)
                .append(HTMLschoolName.replace("%data%", education.schools[i].name) + HTMLschoolDegree.replace("%data%", education.schools[i].degree))
                .append(HTMLschoolDates.replace("%data%", education.schools[i].date))
                .append(HTMLschoolMajor.replace("%data%", education.schools[i].majors))
        ...
        for (i = 0; i < education.onlineCourses.length; i++) {
            $('#education').append(HTMLschoolStart)
                .append(HTMLonlineTitle.replace("%data%", education.onlineCourses[i].title) + HTMLonlineSchool.replace("%data%", education.onlineCourses[i].school))
